...
const testimonials = [
  {
    ...
    quote: "Zoro CRM has transformed our sales process. Our team is more organized, and we've seen a 40% increase in closed deals since implementation.",
    stars: 5,
  },
  {
    name: "Michael Chen",
    ...
    quote: "The customer management features are intuitive and powerful. We're able to provide better support and track customer satisfaction more effectively.",
    stars: 5,
  },
  {
    name: "Emma Rodriguez",
    ...
    quote: "Zoro CRM's integration capabilities have allowed us to create seamless marketing campaigns that directly connect to our sales pipeline.",
    stars: 4,
  },
];
...
const faqs = [
  {
    ...
    answer: "Getting started with Zoro CRM is incredibly simple. Sign up for an account, and our onboarding process will guide you through setting up your workspace. You can import your existing contacts, customize your pipeline, and be up and running in just a few minutes.",
  },
  {
    question: "Can I import my existing customer data?",
    answer: "Yes, Zoro CRM makes it easy to import your existing customer data from CSV files, Excel spreadsheets, or directly from other popular CRM platforms. Our import wizard will guide you through mapping your fields and ensuring a smooth transition.",
  },
  {
    question: "How secure is my data with Zoro CRM?",
    answer: "Security is our top priority. We use enterprise-grade encryption for all data, both in transit and at rest. We're compliant with major security standards, implement strict access controls, and regularly perform security audits to ensure your data remains protected.",
  },
  {
    question: "What kind of support does Zoro CRM offer?",
    answer: "We offer multiple support channels including email, live chat, and phone support depending on your plan. Our knowledge base contains detailed guides and tutorials, and our customer success team is always ready to help you get the most out of Zoro CRM.",
  },
];
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Navbar */}
      <nav ref={navbarRef} className="fixed w-full z-50 transition-all duration-300 py-4" id="navbar">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <a href="/" className="flex items-center">
                <Zap className="h-8 w-8 text-orange-500" />
                <span className="ml-2 text-xl font-bold text-gray-900">Zoro CRM</span>
              </a>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-4 pb-4 space-y-4" id="mobileMenu">
              <a href="#features" className="block text-gray-700 hover:text-orange-500 py-2 transition-colors">Features</a>
              <a href="#testimonials" className="block text-gray-700 hover:text-orange-500 py-2 transition-colors">Testimonials</a>
              <a href="#pricing" className="block text-gray-700 hover:text-orange-500 py-2 transition-colors">Pricing</a>
              <a href="#faq" className="block text-gray-700 hover:text-orange-500 py-2 transition-colors">FAQ</a>
              <a href="#contact" className="block text-gray-700 hover:text-orange-500 py-2 transition-colors">Contact</a>
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col lg:flex-row items-center">
              <div className="lg:w-1/2 lg:pr-12">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Streamline Your <span className="text-orange-500">Customer Relationships</span>
                </h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                Everything You Need to <span className="text-orange-500">Manage Customer Relationships</span>
              </h2>
              <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                Zoro CRM provides all the tools you need to attract, engage, and delight your customers.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {/* 8 Features */}
              {[
                { icon: <Users />, title: "Contact Management", desc: "Easily organize and manage your contacts with comprehensive profiles and interaction history." },
                { icon: <BarChart2 />, title: "Sales Pipeline", desc: "Track deals through your sales process with customizable pipelines and stages." },
                { icon: <Clock />, title: "Task Management", desc: "Never miss a follow-up with automated reminders and task assignments." },
                { icon: <MessageSquare />, title: "Communication Tools", desc: "Engage with customers through integrated email, chat, and call tracking." },
                { icon: <Layers />, title: "Custom Workflows", desc: "Automate repetitive tasks with customizable workflows and triggers." },
                { icon: <Shield />, title: "Data Security", desc: "Keep your customer data secure with enterprise-grade security measures." },
                { icon: <Zap />, title: "Integration Ecosystem", desc: "Connect with your favorite tools and apps for a seamless workflow." },
                { icon: <Database />, title: "Advanced Analytics", desc: "Gain insights into customer behavior and sales performance with detailed reports." }
              ].map((f, i) => (
                <div
                  key={i}
                ...
                >
                  <div className="bg-orange-50 rounded-full w-12 h-12 flex items-center justify-center mb-4">
                    {React.cloneElement(f.icon, { className: "h-6 w-6 text-orange-500" })}
                  </div>
        ...
        <section id="testimonials" className="py-20 bg-orange-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                See what our customers have to say about their experience with Zoro CRM.
              </p>
            </div>
                  ...
                  <div className="md:w-1/3">
                    <div className="relative">
                      ...
                      <div className="flex justify-center mt-4">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} className={`h-5 w-5 ${i < currentTestimonial.stars ? "text-yellow-400 fill-current" : "text-gray-300"}`} fill={i < currentTestimonial.stars ? "#facc15" : "none"} />
                        ))}
                      </div>
                    </div>
                    <div className="text-center mt-4">
                      ...
                      <p className="text-orange-500 font-medium">{currentTestimonial.company}</p>
                    </div>
                  </div>
                  <div className="md:w-2/3">
                    <blockquote>
                      <p className="text-xl text-gray-700 italic">&quot;{currentTestimonial.quote}&quot;</p>
                    </blockquote>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl border border-gray-200 shadow">
                <div className="p-8">
                  ...
                  <div className="mt-4 flex items-baseline">
                    <span className="text-4xl font-extrabold text-gray-900">${prices.starter[isAnnual ? "annual" : "monthly"]}</span>
                    <span className="ml-1 text-xl font-medium text-gray-500">/mo {isAnnual ? "billed annually" : ""}</span>
                  </div>
                  <p className="mt-2 text-gray-600">Perfect for small businesses and startups</p>
                  <ul className="mt-8 space-y-4">
                    {["Up to 1,000 contacts", "Basic contact management", "Email integration", "Task management", "5 user seats", "Standard support"].map((item) => (
              ...
              <div className="rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl border-2 border-orange-500 shadow-lg relative">
                ...
                <div className="p-8">
                  ...
                  <div className="mt-4 flex items-baseline">
                    <span className="text-4xl font-extrabold text-gray-900">${prices.professional[isAnnual ? "annual" : "monthly"]}</span>
                    <span className="ml-1 text-xl font-medium text-gray-500">/mo {isAnnual ? "billed annually" : ""}</span>
                  </div>
                  <p className="mt-2 text-gray-600">Ideal for growing businesses</p>
                  <ul className="mt-8 space-y-4">
                    {["Up to 25,000 contacts", "Advanced contact management", "Email and SMS integration", "Sales pipelines", "Custom dashboards", "15 user seats", "Priority support", "API access"].map((item) => (
                      <li key={item} className="flex items-start">
                        <Check className="h-5 w-5 text-green-500" />
                        <p className="ml-3 text-gray-700">{item}</p>
                      </li>
              ...
              <div className="rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl border border-gray-200 shadow">
                <div className="p-8">
                  ...
                  <div className="mt-4 flex items-baseline">
                    <span className="text-4xl font-extrabold text-gray-900">${prices.enterprise[isAnnual ? "annual" : "monthly"]}</span>
                    <span className="ml-1 text-xl font-medium text-gray-500">/mo {isAnnual ? "billed annually" : ""}</span>
                  </div>
                  <p className="mt-2 text-gray-600">For large organizations with complex needs</p>
                  <ul className="mt-8 space-y-4">
                    {["Unlimited contacts", "Advanced analytics", "Dedicated account manager", "Custom integrations", "Unlimited user seats", "SLA guarantees", "Advanced security features", "AI-powered insights"].map((item) => (
                      <li key={item} className="flex items-start">
                        <Check className="h-5 w-5 text-green-500" />
                        <p className="ml-3 text-gray-700">{item}</p>
                      </li>
        ...
        <section id="faq" className="py-20 bg-gray-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              {faqs.map((faq, idx) => (
                <div key={faq.question} className="bg-white rounded-lg border border-gray-200 overflow-hidden transition-all duration-300">
                  <button
                  ...
                  >
                    ...
                    {openFaqs[idx] ? <ChevronUp className="h-5 w-5 text-gray-500" /> : <ChevronDown className="h-5 w-5 text-gray-500" />}
                  </button>
                  <div
                    className="faq-answer px-6 overflow-hidden transition-all duration-300"
                    style={{ maxHeight: openFaqs[idx] ? "500px" : "0", paddingBottom: openFaqs[idx] ? "1.5rem" : "0" }}
                  >
        ...
        <section id="contact" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                Ready to <span className="text-orange-500">Transform</span> Your Customer Relationships?
              </h2>
              <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                Contact us today to learn how Zoro CRM can help your business grow.
              </p>
            </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-gray-600">
                          123 Business Ave, Suite 500<br />San Francisco, CA 94107
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            <div className="lg:col-span-2">
              ...
              <div className="mt-6 flex space-x-4">
                ...
                <a href="#" className="text-gray-400 hover:text-orange-500 transition-colors"><Github className="h-5 w-5" /></a>
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-400 hover:text-orange-500 transition-colors">Enterprise</a></li>
                <li><a href="#" className="text-gray-400 hover:text-orange-500 transition-colors">Integrations</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-400 hover:text-orange-500 transition-colors">Guides</a></li>
                ...
                <li><a href="#contact" className="text-gray-400 hover:text-orange-500 transition-colors">Support</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6">
                ...
                <a href="#" className="text-gray-500 hover:text-orange-500 text-sm transition-colors">Cookie Policy</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
      ...
      <div className="space-y-4">
        ...
        <div className="pt-4">
          ...
          {sent && <div className="mt-3 text-green-600">Thank you for your message. We will get back to you shortly!</div>}
        </div>
      </div>
    </form>
  );
